...
public class KeyboardReader implements UserInterface {
    ...
    /**
     * KeyboardReader() constructor creates a BufferedReader that is used for command-line and
     * console I/O.
     */
    ...
    /**
     * getUserInput() is a method of the UserInterface class. It returns input read from the
     * keyboard.
     */
    ...
    /**
     * prompt() is a method of the UserInterface class. It prints its parameter.
     * 
    ...
    /**
     * readKeyboard() reads a line of input from the keyboard where reader is a BufferedReader.
     * 
